    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-cream">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-3xl mt-6 mb-2">Create your account</h1>
          <p className="text-muted">Start building your professional profile</p>
        </div>

        {error && <div className="bg-red-50 text-red-600 text-sm p-4 rounded-xl mb-6">{error}</div>}
        {success && <div className="bg-green-50 text-green-600 text-sm p-4 rounded-xl mb-6">{success}</div>}

        <button
          onClick={handleGoogleLogin}
          className="w-full flex items-center justify-center gap-3 bg-white border border-soft py-3 px-4 rounded-xl text-sm font-medium hover:bg-soft transition-colors mb-4"
        >
